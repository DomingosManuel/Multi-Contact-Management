      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="/admin/">
            ...
            <span class="nav-link-text ms-1">todas pessoas</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="/admin/addpessoa">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Cadastrar Pessoa</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="/admin/contactos">
            ...
            <span class="nav-link-text ms-1">Reciclagem</span>
          </a>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Minha Conta</h6>
        </li>
        <li class="nav-item">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none">{{$nome->name}}</span>
              </a>
            </li>
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
