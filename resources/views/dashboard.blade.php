          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Contactos</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Pessoas</p>
                    <h5 class="font-weight-bolder mb-0">
                      {{$pessoas}}
                      <span class="text-success text-sm font-weight-bolder">Total</span>
                    </h5>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Eliminados</p>
                    <h5 class="font-weight-bolder mb-0">
                    {{$lixo}}
                      <span class="text-success text-sm font-weight-bolder">Total</span>
                    </h5>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <p class="mb-1 pt-2 text-bold">Construído por:</p>
                    <h5 class="font-weight-bolder">Domingos Paulo Manuel</h5>
                    <p class="mb-5">De cores, cartões, tipografia a elementos complexos, você encontrará a documentação completa.</p>
          ...
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/ivancik.jpg');">
              ...
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 class="text-white font-weight-bolder mb-4 pt-2">Trabalhe com os foguetes</h5>
                <p class="text-white">A criação de riqueza é um jogo de soma positiva evolutivamente recente. É tudo sobre quem aproveitar a oportunidade primeiro.</p>
